#!/usr/bin/env python3
"""
Test script for the redesigned chatbox frontend-backend integration
"""
import requests
import json

def test_redesigned_chat():
    """Test the redesigned chat integration"""
    base_url = "http://localhost:8000/chat-ai/"
    headers = {"Content-Type": "application/json"}
    
    print("Testing redesigned chat integration...")
